...
public class HttpRequestTest {
    ...
    @Test
    void testPersonStateIsNegative() throws Exception {
        ...
        mockMvc.perform(get("/personState/isNegative").headers(header)).andExpect(status().isOk());
    }

    @Test
    void testPersonStateIsNew() throws Exception {
        ...
        mockMvc.perform(get("/personState/isNew").headers(header)).andExpect(status().isOk());
    }
